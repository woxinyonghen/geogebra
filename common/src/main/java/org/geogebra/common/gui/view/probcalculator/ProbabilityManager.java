...
public class ProbabilityManager {
	 ...
	 */
	public double[] getPlotDimensions(Dist selectedDist, GeoNumeric[] parms,
	 ...
	 */
	public Double[] getDistributionMeasures(Dist selectedDist, GeoNumeric[] parms) {
	 ...
	 * @return probability
	 */
	public double probability(double value, GeoNumeric[] parms, Dist distType,
