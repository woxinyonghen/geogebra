...
public abstract class ProbabilityTable {
	...
	public abstract void setTable(Dist distType2, GeoNumeric[] parms2, int xMin2,
			int xMax2);
	...
	protected void setTableModel(Dist distType1, GeoNumeric[] parms1, int xMin1,
			int xMax1) {
